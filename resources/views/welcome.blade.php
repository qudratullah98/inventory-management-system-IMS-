...
<body>
    <div class="container-scroller">
                    ...
                    <div class="ps-lg-1">
                        <div class="d-flex align-items-center justify-content-between">
                            <p class="mb-0 font-weight-medium me-3 buy-now-text">
                                د اکمالاتو سیستم ته ښه راغلاست</p>
                            <a href="https://www.bootstrapdash.com/product/majestic-admin-pro/?utm_source=organic&utm_medium=banner&utm_campaign=buynow_demo"
                                target="_blank" class="btn me-2 buy-now-btn border-0">مننه !</a>
                        </div>
                    </div>
                    <div class="d-flex align-items-center justify-content-between">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row ltr">
                ...
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link" href="/">
                            ...
                            <span class="menu-title">Inventoris</span>
                        </a>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="fiducial">
                            <i class="mdi mdi-account menu-icon"></i>
                            <span class="menu-title">Distributaries</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="auth">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="login1"> fiducial </a>
                                </li>
                    ...
                    success: function(response) {
                      $("#tbody1").html("");
                       $.each(response.name,function(key,item){
                           $("#tbody1").append("<tr><td>"+item.id+"</td><td>"+item.name+"</td><td>"+item.countity+"</td><td>"+item.remark+"</td><td>"+item.unite+"</td><td></td><td>"+item.invoce_number+"</td><td>"+item.depot.name+"</td><td>"+item.catagory.name+"</td><td><a href='/dispatch/"+item.id+"'>view</a></td></tr>")
                       })
                    },
                })
            });
